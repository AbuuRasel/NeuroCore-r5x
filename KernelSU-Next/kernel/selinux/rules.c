...
static int apply_kernelsu_rules_fn(void *ptr)
{
    ...
    // NeuroCore: v3.4.0 additions - unix stream + memfd (su IPC on
    // modern Android; skipped gracefully if a type is absent).
    ...
    // NeuroCore: let apps reach /data/adb/ksud for su. Post-exec escape()
    // sets uid/caps/sid explicitly, so only file access is needed here.
    // Covers modern + legacy SDK app domains (old Termux = _27).
    ksu_allow(db, "untrusted_app", "adb_data_file", "dir", "search");
    ksu_allow(db, "untrusted_app", "adb_data_file", "file", "getattr");
    ksu_allow(db, "untrusted_app", "adb_data_file", "file", "read");
    ksu_allow(db, "untrusted_app", "adb_data_file", "file", "open");
    ksu_allow(db, "untrusted_app", "adb_data_file", "file", "execute");
    ksu_allow(db, "untrusted_app", "adb_data_file", "file", "map");
    ksu_allow(db, "untrusted_app_27", "adb_data_file", "dir", "search");
    ksu_allow(db, "untrusted_app_27", "adb_data_file", "file", "getattr");
    ksu_allow(db, "untrusted_app_27", "adb_data_file", "file", "read");
    ksu_allow(db, "untrusted_app_27", "adb_data_file", "file", "open");
    ksu_allow(db, "untrusted_app_27", "adb_data_file", "file", "execute");
    ksu_allow(db, "untrusted_app_27", "adb_data_file", "file", "map");
    ksu_allow(db, "untrusted_app_25", "adb_data_file", "dir", "search");
    ksu_allow(db, "untrusted_app_25", "adb_data_file", "file", "getattr");
    ksu_allow(db, "untrusted_app_25", "adb_data_file", "file", "read");
    ksu_allow(db, "untrusted_app_25", "adb_data_file", "file", "open");
    ksu_allow(db, "untrusted_app_25", "adb_data_file", "file", "execute");
    ksu_allow(db, "untrusted_app_25", "adb_data_file", "file", "map");
